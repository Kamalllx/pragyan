...
import sys
import os
sys.path.append(os.path.dirname(r"./debug_output\20250620_135417_mathematics_trignometry_test.py"))
...
try:
    import ast
    with open(r"./debug_output\20250620_135417_mathematics_trignometry_test.py", "r") as f:
        code_content = f.read()
